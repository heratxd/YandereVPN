...
async def xrocket_pay_create(callback: CallbackQuery):
    ...
    from database.requests import get_tariff_by_id, save_xrocket_invoice_id
...
async def renew_xrocket_create(callback: CallbackQuery):
    ...
    from database.requests import get_tariff_by_id, get_key_details_for_user, save_xrocket_invoice_id
    from bot.services.billing import create_xrocket_payment
